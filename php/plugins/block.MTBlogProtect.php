  ...
  global $tk_token, $logged_in, $login_url, $name, $nick, $logout_url;	
    ...
    $protected = $ctx->mt->db->get_row($sql, ARRAY_A);		
        ...
        $ctx->stash('middle',$middle);		
			...
			elseif($type == 'Typekey'){
//				$signintext = $args['tk_signin_text'] || "This blog has been Typekey protected so only selected Typekey users can read it. ";
//				$notallowed = $args['tk_barred_text'] || "You do not have the rights to access this blog. Sorry!";				
